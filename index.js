...
function insertInitPourHtml(stPour, ndPour) {
  document.getElementById("init").innerHTML += "<li id='first'> 1st pour " +
    Math.round(stPour) + " grams of water (0:00)</li>";
  document.getElementById("init").innerHTML += "<li id='second'> 2nd pour " +
...
function createPourOver(strength, weight) {
  ...
  if (strength === "soft") {
    document.getElementById("pour-over").innerHTML +=
      "<li id='third'> 3rd pour " + Math.round(restWater) +
      " grams of water - " + Math.round(initPour + restWater) +
      " g total (1:30)</li>";
  } else if (strength === "medium") {
    document.getElementById("pour-over").innerHTML +=
      "<li id='third'> 3rd pour " + Math.round(restWater / 2) +
      " grams of water - " + Math.round(initPour + restWater / 2) +
      " g total (1:30)</li>";
    document.getElementById("pour-over").innerHTML +=
      "<li id='fourth'> 4th pour " + Math.round(restWater / 2) +
      " grams of water - " + Math.round(initPour + restWater) +
      " g total (2:15)</li>";
  } else {
    document.getElementById("pour-over").innerHTML +=
      "<li id='third'> 3rd pour " + Math.round(restWater / 3) +
      " grams of water - " + Math.round(initPour + restWater / 3) +
      " g total (1:30)</li>";
    document.getElementById("pour-over").innerHTML +=
      "<li id='fourth'> 4th pour " + Math.round(restWater / 3) +
